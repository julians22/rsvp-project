...
<div x-data="{
    ...
    <div class="form-group relative mt-2">
        <button
            class="text-normal form-label relative w-full cursor-pointer border border-black bg-white py-2 pl-3 pr-10 text-left text-black shadow-sm ring-1 ring-inset ring-gray-300 focus:border-gray-300 focus:ring-gray-300"
